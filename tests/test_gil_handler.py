...
Rust Implementation Location: technical_architecture/src/(native Rust)
- Python module → Rust has no GIL
...
pytestmark = pytest.mark.skip(
    reason="Module migrated to Rust (technical_architecture/src/(native Rust)). "
)
