...
class Test17DSourceMetadata(unittest.TestCase):
    ...
    def test_all_getters_setters(self):
        ...
        metadata = SourceMetadata(
            ...
            vibrato_rate_hz=8.0, vibrato_depth=50.0, jitter=0.02,
...
class Test17DSynthesisIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.audio_buffer = [
            0.5 * np.sin(2.0 * np.pi * 7000.0 * i / 22050.0)
    ...
    def test_gritty_vs_pure_persona_metadata(self):
        ...
        gritty = SourceMetadata(
            mean_f0_hz=6500.0, duration_ms=45.0, f0_range_hz=800.0,
            ...
            mfcc_1=-200.0, mfcc_2=-50.0, mfcc_3=-20.0, mfcc_4=-10.0,
        ...
        # PURE: Contact call
        pure = SourceMetadata(
            mean_f0_hz=6500.0, duration_ms=70.0, f0_range_hz=300.0,
            ...
            mfcc_1=-600.0, mfcc_2=-120.0, mfcc_3=-60.0, mfcc_4=-25.0,
            spectral_contrast=25.0,
            median_ici_ms=0.0, onset_rate_hz=0.0, ici_coefficient_of_variation=0.0,
        )

        # Verify persona characteristics
        self.assertLess(gritty.get_harmonic_to_noise_ratio(),
                       pure.get_harmonic_to_noise_ratio())
        self.assertGreater(gritty.get_spectral_flatness(),
                          pure.get_spectral_flatness())
        self.assertLess(gritty.get_attack_time_ms(),
                       pure.get_attack_time_ms())
        self.assertGreater(gritty.get_jitter(),
                          pure.get_jitter())
    ...
    def test_rhythmic_vs_harmonic_metadata(self):
        ...
        rhythmic = SourceMetadata(
            mean_f0_hz=8000.0, duration_ms=30.0, f0_range_hz=200.0,
            harmonic_to_noise_ratio=15.0, spectral_flatness=0.2,
            attack_time_ms=5.0, decay_time_ms=10.0, sustain_level=0.3,
            vibrato_rate_hz=0.0, vibrato_depth=10.0, jitter=0.03,
            mfcc_1=-400.0, mfcc_2=-80.0, mfcc_3=-40.0, mfcc_4=-15.0,
        ...
        harmonic = SourceMetadata(
            mean_f0_hz=8000.0, duration_ms=100.0, f0_range_hz=200.0,
            harmonic_to_noise_ratio=25.0, spectral_flatness=0.05,
            attack_time_ms=15.0, decay_time_ms=20.0, sustain_level=0.8,
            vibrato_rate_hz=10.0, vibrato_depth=50.0, jitter=0.01,
            mfcc_1=-500.0, mfcc_2=-100.0, mfcc_3=-50.0, mfcc_4=-20.0,
            spectral_contrast=20.0,
...
class TestBackwardCompatibility(unittest.TestCase):
    ...
    def test_legacy_delta_commands_still_work(self):
        ...
        metadata = SourceMetadata(
            mean_f0_hz=6800.0, duration_ms=50.0, f0_range_hz=400.0,
            harmonic_to_noise_ratio=20.0, spectral_flatness=0.1,
            attack_time_ms=10.0, decay_time_ms=15.0, sustain_level=0.7,
            vibrato_rate_hz=8.0, vibrato_depth=50.0, jitter=0.02,
            mfcc_1=-500.0, mfcc_2=-100.0, mfcc_3=-50.0, mfcc_4=-20.0,
