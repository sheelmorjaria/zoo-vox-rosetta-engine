...
class TestCompositionalValidator:
    ...
    def test_chi_squared_test_uniformity(self):
        ...
        uniform_grammar = {"A": {"B": 5, "C": 5}, "B": {"A": 5, "C": 5}, "C": {"A": 5, "B": 5}}
    ...
    def test_generate_validation_report(self):
        ...
        result = self.validator.generate_validation_report(self.sample_phrases, self.sample_grammar)
    ...
    def test_validation_result_class(self):
        ...
        result = ValidationResult(is_valid=True, confidence=0.95, message="Validation passed")
    ...
    def test_probability_calculation(self):
        ...
        assert (
            prob == 10 / 15
        )  # 10 transitions from phrase1 to phrase2 out of 15 total from phrase1
