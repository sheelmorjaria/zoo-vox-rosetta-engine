...
EXTRACTION_LOG = "/mnt/c/Users/sheel/Desktop/data/egyptian_fruit_bats/extraction_112d/extraction.log"
...
def run_pcfg_analysis():
    ...
    print(f"  Saved {len(sequences_by_context)} contexts with {sum(len(s) for s in sequences_by_context.values())} total sequences")
