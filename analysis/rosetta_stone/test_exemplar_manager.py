...
from analysis.rosetta_stone.exemplar_manager import ClusterInfo, ExemplarManager, SegmentInfo
...
class TestSegmentInfo:
    ...
    def test_segment_info_creation(self):
        ...
        segment = SegmentInfo(
            file_path="test.wav", features_112d=[0.5] * 112, duration_ms=100.0, mean_f0_hz=8000.0
        )
...
class TestExemplarManager:
    ...
    def test_add_segment(self):
        ...
        manager.add_segment(
            file_path="seg_001.wav", features_112d=[0.5] * 112, duration_ms=100.0, mean_f0_hz=8000.0
        )
